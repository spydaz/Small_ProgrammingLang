'---------------------------------------------------------------------------------------------------
' file:		CodeAnalysis\Evaluator.vb
'
...
Namespace Global.Basic.CodeAnalysis
    ...
    Friend NotInheritable Class Evaluator
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate expression statement. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <param name="node"> The node. </param>
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate constant expression. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <param name="node"> The node. </param>
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate variable expression. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <param name="v">    A BoundVariableExpression to process. </param>
        '''
        ''' <returns>   An Object. </returns>
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <param name="a">    A BoundAssignmentExpression to process. </param>
        '''
        ''' <returns>   An Object. </returns>
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate binary expression. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
        '''
        ''' <param name="b">    A BoundBinaryExpression to process. </param>
        '''
        ''' <returns>   An Object. </returns>
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate call expression. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <param name="node"> The node. </param>
...
#End If
        ...
        '''////////////////////////////////////////////////////////////////////////////////////////////////////
        ''' <summary>   Evaluate conversion expression. </summary>
        '''
        ''' <remarks>   Leroy, 27/05/2021. </remarks>
        '''
        ''' <exception cref="Exception">    Thrown when an exception error condition occurs. </exception>
