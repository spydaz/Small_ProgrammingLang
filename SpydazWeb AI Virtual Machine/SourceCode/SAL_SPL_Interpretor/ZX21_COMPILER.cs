...
using SAL_VM.SmallProgLang.Evaluator;
using SAL_VM.SmallProgLang.GrammarFactory;
...
// AST FACTORY
// 
namespace SAL_VM.SmallProgLang
{
                ...
                case "NOT":
                    {
                        ...
                        string localToInt() { bool argBool = Conversions.ToBoolean(hs137455cf94ad409e9bae3358a1eed344()); var ret = ToInt(ref argBool); return ret; }
                    ...
                    case "NOT":
                        {
                            ...
                            string localToInt6() { bool argBool = Conversions.ToBoolean(hsd52e47787f7546ab9cfee41ff6f5a9e5()); var ret = ToInt(ref argBool); return ret; }
