    ...
    Public Function GetUrl(ByRef Text As String) As String
        Select Case Text
            ...
            Case "VB Online Compiler"
                Return "https://rextester.com/l/visual_basic_online_compiler"
            Case "Online Assembler Nasm"
                Return "https://www.jdoodle.com/compile-assembler-nasm-online/"
            Case "BNF PlayGround"
                Return "https://bnfplayground.pauliankline.com/"
            Case "Assembly Compiler"
                Return "https://www.tutorialspoint.com/compile_assembly_online.php"
        End Select
        Return Nothing
    End Function
