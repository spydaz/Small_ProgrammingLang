...
Partial Class SAL_MachineUI
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBoxURL.Items.AddRange(New Object() {"Amiga Workbench Simulator", "Windows 3.1", "Windows 3.1 with CD-ROM", "Macintosh System 7", "Windows 95", "OS/2", "Windows 93", "Atari ST", "Windows 1.0", "EmuOS", "Mac Oxs Lion 10", "PCDOS 5", "Mac os7", "Mermaid diagrams", "AST Explorer", "Visual basic", "Nearly Parser", "Code Script Prettier", ".NET", "Web Assembly Studio", "WASM Explorer", "VB Online Compiler", "BNF PlayGround", "Online Assembler Nasm", "Assembly Compiler"})
